...
sudo apt-get -qq install stow fasd tree meld jq vim ruby subversion composer php-xml awscli curl g++ build-essential kitty openjdk-17-jdk openjdk-17-jre python3-pip julia golang cargo luarocks markdown
sudo update-alternatives --set editor /usr/bin/vim.basic

echo "Installing utilities…"
sudo apt-get -qq install neofetch htop imagemagick libimage-exiftool-perl poedit myspell-es aspell-es silversearcher-ag ripgrep
